...
const categories = [
  {
    title: "Tech Gifts",
    image: "https://22527425.fs1.hubspotusercontent-na1.net/hubfs/22527425/Byyu%20landing%20page/Tech%20Gifts.png",
    bg: "bg-[#2F2F2F]",
  ...
  {
    title: "Drinkware",
    image: "https://22527425.fs1.hubspotusercontent-na1.net/hubfs/22527425/Byyu%20landing%20page/Drinkware.png",
    bg: "bg-[#A2A7AA]",
  ...
  {
    title: "Gift Sets",
    image: "https://22527425.fs1.hubspotusercontent-na1.net/hubfs/22527425/Byyu%20landing%20page/Gift%20Sets.png",
    bg: "bg-[#A2A7AA]",
    button: "bg-[#232323] text-white",
    text: "text-[#232323]",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className={`rounded-2xl p-0 flex flex-row items-center h-full relative ${categories[0].bg}`}> {/* Tech Gifts */}
              ...
              <div className="flex items-center justify-center p-6">
                <div className="bg-white rounded-2xl p-4 flex items-center justify-center">
                  <Image src={categories[0].image} alt={categories[0].title} width={140} height={100} className="object-contain" />
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-6">
            <div className={`rounded-2xl p-0 flex flex-row items-center h-full relative ${categories[1].bg}`}> {/* Drinkware */}
              ...
              <div className="flex items-center justify-center p-6">
                <div className="bg-white rounded-2xl p-4 flex items-center justify-center">
                  <Image src={categories[1].image} alt={categories[1].title} width={140} height={100} className="object-contain" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`rounded-2xl p-0 flex flex-row items-center h-full relative ${categories[2].bg}`}> {/* Gift Sets */}
              ...
              <div className="flex items-center justify-center p-6">
                <div className="bg-white rounded-2xl p-4 flex items-center justify-center">
                  <Image src={categories[2].image} alt={categories[2].title} width={140} height={100} className="object-contain" />
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-6">
            <div className={`rounded-2xl p-0 flex flex-row items-center h-full relative ${categories[3].bg}`}> {/* Stationery */}
              ...
              <div className="flex items-center justify-center p-6">
                <div className="bg-white rounded-2xl p-4 flex items-center justify-center">
                  <Image src={categories[3].image} alt={categories[3].title} width={140} height={100} className="object-contain" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`rounded-2xl p-0 flex flex-row items-center h-full relative ${categories[4].bg}`}> {/* Sustainable Gifts */}
              ...
              <div className="flex items-center justify-center p-6">
                <div className="bg-white rounded-2xl p-4 flex items-center justify-center">
                  <Image src={categories[4].image} alt={categories[4].title} width={140} height={100} className="object-contain" />
                </div>
              </div>
            </div>
          </div>
